...
export default function SignInListener() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error("SignInListener error:", err);
  ...
  return (
    <div className="container">
      <div className="card small">
        <h2>Sign In</h2>
        <p className="lead">Sign in as listener</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <button className="btn primary" type="submit">Sign In as Listener</button>
          </div>
        </form>
      </div>
    </div>
